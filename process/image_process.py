...
IMAGE_SIZE, BASE_SIZE, CROP_MODE, MIN_CROPS, MAX_CROPS, PROMPT, TOKENIZER = model_config.IMAGE_SIZE, model_config.BASE_SIZE, model_config.CROP_MODE, model_config.MIN_CROPS, model_config.MAX_CROPS, model_config.DEFAULT_PROMPT, model_config.TOKENIZER
